...
export default function ProfanityModal({ isOpen, onClose }: ProfanityModalProps) {
    if (!isOpen) {
        return null;
    }
    ...
    return (
        <div className="fixed inset-0 z-100 flex items-center justify-center p-6">
            ...
            >
                ...
                <h2 id="profanity-modal-title" className="text-2xl font-black tracking-tight text-red-600 dark:text-red-400">
                    Please use proper language
                </h2>

                <p className="mt-3 text-sm font-medium leading-relaxed text-slate-600 dark:text-slate-300">
                    Your post contains abusive language. Please revise it and try again.
                </p>
