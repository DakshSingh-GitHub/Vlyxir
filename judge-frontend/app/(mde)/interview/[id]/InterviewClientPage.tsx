...
export default function InterviewClientPage({ params }: { params: Promise<{ id: string }> }) {
            ...
            <div className="flex items-center gap-3 mt-4">
              <button
                ...
                className={`flex-1 py-2.5 rounded-xl border text-[10px] font-black uppercase tracking-widest transition-colors cursor-pointer ${
                  isDark ? "border-slate-855 hover:bg-slate-800 text-slate-400 hover:text-white" : "border-slate-200 hover:bg-slate-100 text-slate-500"
                }`}
              >
                Cancel
              </button>
