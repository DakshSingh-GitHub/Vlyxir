                    ...
                    <div className="relative flex items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2 md:gap-4">
                            ...
                            <div className="relative" ref={profileRef}>
                                ...
                                {isProfileOpen && (
                                    <div className={`absolute right-0 z-50 mt-4 w-80 overflow-hidden rounded-4xl border p-2 shadow-[0_30px_70px_rgba(0,0,0,0.5)] backdrop-blur-3xl animate-in fade-in slide-in-from-top-4 duration-300 ${isDark
